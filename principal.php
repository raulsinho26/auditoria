...
<div id="page" class="container">
  ...
  <div class="form">
    <form name="fomrm_cadastro" action="cadAuditor.php" method="post">
				 <label><span>DADOS GERAIS</span></label><br><br>
					...
					<label><span>FORMAÇÃO ACADEMICA</span></label><br><br>
					 ...
					 <div class="form-group">
                        <input type="text" class="form-control" placeholder="Curso1" required="">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Instituição" required="">
                    </div>
					<div class="form-group">
                        <input type="text" class="form-control" placeholder="Ano Conclusão" required="">
                    </div>
